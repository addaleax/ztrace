...
class ZTrace {
  ...
  hookValue(name, value, context) {
    ...
    const kUnwrappedFunction = this.kUnwrappedFunction;
    const kIsHooked = this.kIsHooked;
    value[kIsHooked] = false;
    ...
    value[this.kCachedProxy] = new Proxy(value, {
      ...
      get: function(target, property, receiver) {
        if (property === kUnwrappedFunction) {
          return target;
        } else if (property === kIsHooked) {
          return true;
        } else {
