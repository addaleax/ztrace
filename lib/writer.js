...
const { ZTraceGlobal } = require('./ztrace.js');
const { formatArgs } = require('./formatting.js');
...
class ZTraceWriter {
  ...
  init(options, ztrace = null) {
    ...
    if (ztrace === null) {
      ztrace = new ZTraceGlobal(options);
    }
